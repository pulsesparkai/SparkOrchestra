    ...
    <div className="min-h-screen bg-gray-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
          ...
          {/* Early Adopter Plan */}
          <Card className="bg-gray-700 border-orange-600 shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden">
            {/* Recommended Badge */}
                      ...
                      <tr key={index} className="border-b border-gray-600/50 hover:bg-gray-600/30 transition-colors">
                        ...
                        <td className="p-4 text-center">
                          {typeof feature.earlyAdopter === 'boolean' ? (
                            ...
                            <span className="text-orange-300 font-medium">{feature.earlyAdopter}</span>
                          )}
                        </td>
                      </tr>
                    ))}
